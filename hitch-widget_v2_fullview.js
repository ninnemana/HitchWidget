...
function loadConfigurator(years){
    ...
    if(jQuery('#configurator').length > 0){
        ...
        jQuery('#configurator').append(yearHTML);
        jQuery('#year').css('display','inline-block');
...
function loadMakes(makes){
	jQuery('#make').html('<option value="0">- Select Make - </option>');
	jQuery('#model').html('<option value="0">- Select Model - </option>');
	jQuery('#style').html('<option value="0">- Select Style - </option>');
