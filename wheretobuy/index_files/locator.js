	...
	var contents = new Array();
		...
		contents[0] += '<div class="linkContainer"><a class="toolLink" href="http://www.autoanything.com/towing/20a52080a1.aspx" target="_blank"><span class="eliteName">AutoAnything.com</span><br /><span>Click Here to Buy Online.</span></a></div>';
		contents[0] += '</td>';


		contents[1] =  '<td style="text-align: center; vertical-align: middle;">';
		contents[1] += '<div class="linkContainer"><a class="toolLink" href="http://www.discounthitches.com" target="_blank"><span class="eliteName">DiscountHtiches.com</span><br /><span>Click Here to Buy Online.</span></a></div>';
		contents[1] += '</td>';


		contents[2] =  '<td style="text-align: center; vertical-align: middle;">';
		contents[2] += '<div class="linkContainer"><a class="toolLink" href="http://www.hitchsource.com/" target="_blank"><span class="eliteName">HitchSource.com</span><br /><span>Click Here to Buy Online.</span></a></div>';
		contents[2] += '</td>';


		contents[3] =  '<td style="text-align: center; vertical-align: middle;">';
		contents[3] += '<div class="linkContainer"><a class="toolLink" href="http://www.jcwhitney.com/Hitches_Towing_and_Trailers?ID=7;1101002309;510001250;0;100001;Category;0;0;0;0;0;0" target="_blank"><span class="eliteName">JCWhitney.com</span><br /><span>Click Here to Buy Online.</span></a></div>';
		contents[3] += '</td>';


		contents[4] =  '<td style="text-align: center; vertical-align: middle;">';
		contents[4] += '<div class="linkContainer"><a class="toolLink" href="http://www.thehitchstore.com/" target="_blank"><span class="eliteName">TheHitchStore.com</span><br /><span>Click Here to Buy Online.</span></a></div>';
		contents[4] += '</td>';


		contents[5] =  '<td style="text-align: center; vertical-align: middle;">';
		contents[5] += '<div class="linkContainer"><a class="toolLink" href="http://www.BuyCurtHitches.com" target="_blank"><span class="eliteName">BuyCURTHitches.com</span><br /><span>Click Here to Buy Online.</span></a></div>';
		contents[5] += '</td>';


		contents[6] =  '<td style="text-align: center; vertical-align: middle;">';
		contents[6] += '<div class="linkContainer"><a class="toolLink" href="http://hitchdepotusa.com" target="_blank"><span class="eliteName">HitchDepotUSA.com</span><br /><span>Click Here to Buy Online.</span></a></div>';
		contents[6] += '</td>';
