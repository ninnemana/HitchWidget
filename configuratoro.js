    ...
    if (typeof(jQuery) == 'undefined') {
	    ...
	    */
		...
		jQuery('#configurator').css('display','block');
                ...
                inputHTML = '<input type="submit" id="lookup_submit" name="lookup_submit" value="Find Hitch" onclick="findHitches()" />';
                jQuery('#configurator').append(inputHTML);
                
                clearHTML = '<a href="javascript:clearResult()" style="display:none" id="clear">Clear</a>';
                jQuery('#configurator').append(clearHTML);
                ...
                jQuery('.mini').live('click',function(){
                    ...
                    $('#mainImage img').attr('src',miniSrc);
